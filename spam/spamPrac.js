const customer = {
  ...
  const customerEmails = customer.customers.map(function (property, index) {
    let mails = customer.customers[index].contacts.email;
    return mails  
  });
    ...
    const emailsTogether = customerEmails.join().split(',')
        

    console.log(emailsTogether);




//       property.filter(function (innerProperty){
...
//             const customerEmail = (innerProperty.contacts === "email"); 
//             return customerEmail
//          }).reduce(function (currentTotal, next) {
